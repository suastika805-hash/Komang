      ...
      <div className="relative z-10 max-w-5xl w-full mx-auto">
        <div className="flex flex-col-reverse md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            {/* CTAs */}
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 animate-fade-up" style={{ animationDelay: "0.35s", opacity: 0, animationFillMode: "forwards" }}>
              <Link
                href="/projects"
          ...
          <div className="flex-shrink-0 animate-fade-in">
            <div className="relative w-56 h-56 sm:w-72 sm:h-72">
              {/* Accent ring */}
              <div className="absolute inset-0 rounded-2xl border-2 border-accent/30 translate-x-3 translate-y-3" />
              <div className="relative w-full h-full rounded-2xl overflow-hidden border-2 dark:border-white/10 border-gray-200">
                <Image
                  src="/foto_saya.jpg"
