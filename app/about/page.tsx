    ...
    <main className="min-h-screen dark:bg-gray-950 bg-white pt-24 pb-20 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6 mb-12">
          <div className="relative w-28 h-28 rounded-2xl overflow-hidden flex-shrink-0 border-2 border-accent/30">
            <Image src="/foto_saya.jpg" alt={profile.name} fill className="object-cover object-top" priority />
          </div>
          <div>
        <h1 className="text-5xl font-display font-bold dark:text-white text-gray-900 mb-2">
          {profile.name}
        </h1>
        <p className="dark:text-gray-400 text-gray-600 mb-0 text-lg">
